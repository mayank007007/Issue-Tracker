...
filterIssueForm.addEventListener('submit', (e) => {
    ...
    // This suggests that the elements being filtered are likely checkboxes or radio buttons, and only the checked ones are being retained in the labelElements array.
